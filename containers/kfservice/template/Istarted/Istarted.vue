<template>
	<div class="Istarted">
		<div class="Istartedheader">
			<span class="pagelocation">工单管理/我创建的</span>
			...
			<div class="tablelist">
				<div class="searchbox">
					<div class="selectInput">
						...
						<div class="selectbox">
							<el-date-picker v-model="datavalue" type="daterange" align="right" value-format="yyyy-MM-dd" :clearable='true'
							 unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions"
							 @change="datechange" class="select1">
							</el-date-picker>
				...
				<div class="table">
					<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" size="small" height="661">
						<el-table-column prop="code" label="工单编号" show-overflow-tooltip width="100">
...
<script>
	import Istarted from './Istarted.js'
	export default {
		...Istarted
	}
</script>
