<template>
	<div class="Idealwith">
		<div class="Istartedheader">
			<span class="pagelocation">工单管理/我处理的</span>
			...
			<div class="tablelist">
				<div class="searchbox">
					<div class="selectInput">
						<input type="text" v-model="selectInput" placeholder="搜索工单号/创建人">
						...
						<div class="selectbox">
							<el-date-picker v-model="datavalue" type="daterange" align="right"  value-format="yyyy-MM-dd"  :clearable='true' unlink-panels range-separator="至"
							 start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions"  @change="datechange" class="select1">
							</el-date-picker>
							<el-select v-model="billtypevalue" placeholder="工单分类" class="select"  @change="billtypechange" :clearable='true'>
				...
				<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark"  size="small" height="661">
					...
					<el-table-column prop="priority" show-overflow-tooltip width="150" >
						...
						<template slot-scope="scope">
							...
							<el-tag type="danger" v-if="tableData[scope.$index].priority==4" >最高(15分钟)</el-tag>
						</template>
					</el-table-column>
					...
					<el-table-column fixed="right"  width="100">
						...
						<template slot-scope="scope">
							<el-button @click.native.prevent="showbillDetail(tableData[scope.$index].code,tableData[scope.$index].userId)" type="text" size="small">
								详情
							</el-button>
						</template>
					</el-table-column>
...
<script>
	import Idealwith from './Idealwith.js'
	export default {
		...Idealwith
	}
</script>
